    ...
    return (
        <View style={{flex: 1, paddingHorizontal: 10}}>
            ...
            <AppButton
                ...
                onPress={() => {
                    setFoundDevices([])
                    BLEService.initializeBLE().then(() => BLEService.scanDevices(addFoundDevice, null, { legacyScan: true }))
                }}
            />
            <AppButton
                ...
                onPress={() => {
                    setFoundDevices([])
                    BLEService.initializeBLE().then(() => BLEService.scanDevices(addFoundDevice, null, { legacyScan: false }))
                }}
            />
            <FlatList
                style={{ flex: 1 }}
